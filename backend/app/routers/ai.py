...
FULL_ARTICLE_SYSTEM = """คุณเป็นนักเขียนข่าวเกษตรและปุ๋ยมืออาชีพสำหรับตลาดไทย

เขียนบทความข่าวภาษาไทยที่สมบูรณ์ในแบบที่นักธุรกิจเกษตรอ่านแล้วเข้าใจทันที
ห้ามแต่งข้อเท็จจริงที่ไม่มีในชื่อข่าว แต่สามารถอธิบายบริบทและวิเคราะห์ได้
ต้องแยกชัดเจนระหว่างข้อเท็จจริงจากข่าว กับการวิเคราะห์เพิ่มเติม"""

FULL_ARTICLE_PROMPT = """สร้างบทความข่าวภาษาไทยแบบสมบูรณ์จากข้อมูลด้านล่าง
...
โครงสร้างที่ต้องการ (ตอบเป็น JSON):
{{
  "headline_th": "หัวข้อข่าวภาษาไทยที่กระชับและน่าสนใจ",
  "summary": "สรุป 2-3 ประโยค เข้าใจง่าย",
  "body": "เนื้อหาบทความ 4-6 ย่อหน้า อธิบายเหตุการณ์ → บริบทตลาดโลก → ผลกระทบไทย",
  "thailand_impact": "ผลกระทบต่อไทยและร้านปุ๋ย 2-3 ประโยค",
  "south_thailand_impact": "ผลกระทบต่อภาคใต้ ยาง ปาล์ม ทุเรียน (ถ้าเกี่ยวข้อง)",
  "business_tip": "คำแนะนำสั้นๆ สำหรับร้านปุ๋ยหรือเกษตรกร",
  "key_facts": ["ข้อเท็จจริงสำคัญ 1", "ข้อเท็จจริงสำคัญ 2", "ข้อเท็จจริงสำคัญ 3"],
  "uncertainty_note": "สิ่งที่ยังไม่แน่นอนและควรติดตาม"
}}"""
...
def full_article(article_id: int, session: Session = Depends(get_session)):
    ...
    if article.summary_ai and article.impact_thailand and len(article.summary_ai) > 200:
        return {
            "article_id": article.id,
